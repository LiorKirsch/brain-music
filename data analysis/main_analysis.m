...
for i = 1:num_channels
    % [X,y] = split_into_n_chunks(X,y,n);
    fprintf('===== channel %d =====\n', i);
    [weights{i}, aucs{i}, models{i}, uniqueLabels] = svm_classification(X(:,:,i), y, conf);
end

save('results/classification_results_white_noise_normalizing','weights', 'aucs', 'models','uniqueLabels');
